...
function themeFiles() {
    ...
    wp_register_script('gsap', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.11.4/gsap.min.js', array('jquery'), ASSETS_VERSION, true);
    wp_enqueue_script('gsap');

    wp_register_script('scrollTrigger', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.11.4/ScrollTrigger.min.js', array('jquery', 'gsap'), ASSETS_VERSION, true);
    wp_enqueue_script('scrollTrigger');

    wp_register_script('javascript', get_stylesheet_directory_uri() . '/assets/js/main.js', array('jquery', 'gsap', 'scrollTrigger'), ASSETS_VERSION, true);
...
function enqueueTargetAssets($page) {
    $pageAssetsConfig = (object) array(
        ...
        "lp" => ["javascripts" => [], "css" => ["home.min.css"], "type" => "page", "concat" => true]
    );
